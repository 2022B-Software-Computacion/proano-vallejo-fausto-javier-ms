...
class AdapterPersona(
    ...
    val idCasa: String
) : RecyclerView.Adapter<AdapterPersona.MyViewHolderPersona>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolderPersona {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.persona_item, parent, false)
        return MyViewHolderPersona(itemView)
    }

    override fun onBindViewHolder(holder: MyViewHolderPersona, position: Int) {
    ...
    class MyViewHolderPersona(itemView: View) : RecyclerView.ViewHolder(itemView) {
