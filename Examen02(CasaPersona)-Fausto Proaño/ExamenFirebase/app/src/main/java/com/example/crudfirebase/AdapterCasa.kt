...
class AdapterCasa(var casaList: ArrayList<Casa>, private val contenidoIntentExplicito: ActivityResultLauncher<Intent>) : RecyclerView.Adapter<AdapterCasa.MyViewHolderCasa>() {




    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolderCasa {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.casa_item, parent, false)

        return MyViewHolderCasa(itemView)

    }

    override fun onBindViewHolder(holder: MyViewHolderCasa, position: Int) {
    ...
    class MyViewHolderCasa(itemView: View) : RecyclerView.ViewHolder(itemView) {
